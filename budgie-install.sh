pacman -S --noconfirm xorg xorg-xinit xf86-video-intel xf86-input-synaptics xterm
...
wget https://github.com/bh1rio/archlinux-install/raw/master/xinitrc-budgite
